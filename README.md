...
A multiplayer voxel arena shooter with destructible cover, fifteen weapons and bots that keep the action moving. Jump into Quick Play, invite friends to a custom lobby, or work on your aim in the Killhouse.
...
- **Find your weapon.** Rifles, a shotgun, a revolver, a sniper, an LMG, a minigun, a flamethrower, rockets, the GL-3 SKIPJACK, whose three-round cassette fires arcing bouncing grenades, melee, ricocheting LONGARC bolts, the piercing VOLTLANCE, the GV-4 RIPTIDE, whose discs cut out, loop home and are caught to reload, and the SB-1 SUDSBLASTER, whose tapped or charged bubbles float up, pop, shove and soak. Add cookable frags, laser claymores and pulse shocks.
...
| Chaos Lab | Kills and hidden $300 cash bundles earn credits for 60 cumulative upgrades across all fifteen weapons and five throwables. Open the lab with B; upgrades survive death. |
