...
export function runEnergyFxContracts(ok) {
  ...
  const fullLength = beams.pool[0].length;
  beams.shoot({ o: [0, 2, 0], d: [0, 0, -1], charge: 0 });
  ok(fullLength > beams.pool[1].length && fullLength < 60 && beams.pool[0].group.visible,
    'charged rail prediction crosses more hard cover with a finite energy budget');
