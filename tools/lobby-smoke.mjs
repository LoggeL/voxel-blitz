...
const SNIPER_SLOT = 3;
const AUTHORITATIVE_TICK_MS = 1000 / 60;
...
function assertLobbyState(
  ...
  pass(state.members.every((member) => Object.keys(member).sort().join(',') === (member.bot ? 'bot,difficulty,id,name,ping,ready,team' : 'bot,id,name,ping,ready,team')),
