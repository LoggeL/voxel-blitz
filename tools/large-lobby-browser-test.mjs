...
try {
  ...
  await page.waitFor(`document.querySelector('.vb-lobby-backdrop').dataset.image === '/assets/maps/canyon.webp' && document.querySelector('.vb-lobby-backdrop').dataset.loading === 'false'`);
  ...
  await set('#map-select', 'harbor');
  await page.waitFor(`document.querySelector('.vb-lobby-backdrop').dataset.image === '/assets/maps/harbor.webp' && document.querySelector('.vb-lobby-backdrop').dataset.loading === 'false'`);
