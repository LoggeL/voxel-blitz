...
const weaponIds={bison:'lmg',fang:'revolver',halo:'longarc',hydra:'minigun',ifrit:'flamethrower',kestrel:'rifle',mastiff:'shotgun',peregrine:'sniper',pike:'lance',talon:'knife',skua:'glaive',torch:'rocket',wasp:'smg'};
