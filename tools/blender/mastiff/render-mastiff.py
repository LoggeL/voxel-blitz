#!/usr/bin/env python3
"""Render hero/side/left/ads/rear proof shots of the MASTIFF study.

Usage:
    blender --background --factory-startup docs/design/blender/mastiff/mastiff.blend \\
        --python tools/blender/mastiff/render-mastiff.py
"""
import bpy
import sys
...
VIEWS = {
    ...
    'hero': ((1.55, -1.25, 0.85), (0.0, 0.15, 0.03), 55),
    'side': ((3.0, 0.15, 0.05), (0.0, 0.15, 0.05), 80),
    'left': ((-3.0, 0.15, 0.05), (0.0, 0.15, 0.05), 80),
    'ads': ((0.0, -0.75, 0.26), (0.0, 0.50, 0.10), 45),
    'rear': ((-1.4, -1.1, 0.7), (0.0, 0.05, 0.03), 55),
}
...
cam_data = bpy.data.cameras.new('MASTIFF camera')
cam = bpy.data.objects.new('MASTIFF camera', cam_data)
