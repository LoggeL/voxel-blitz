#!/usr/bin/env python3
"""Render hero/side/ads/rear proof shots of the HALO study.

Usage:
    blender --background --factory-startup docs/design/blender/halo/halo.blend \\
        --python tools/blender/halo/render-halo.py
"""
import bpy
import sys
...
cam_data = bpy.data.cameras.new('HALO camera')
cam = bpy.data.objects.new('HALO camera', cam_data)
