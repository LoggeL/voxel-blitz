#!/usr/bin/env python3
"""Render hero/side/ads/rear proof shots of the BALLISTA study.

Usage:
    blender --background --factory-startup docs/design/blender/ballista/ballista.blend \\
        --python tools/blender/ballista/render-ballista.py
"""
import bpy
import sys
...
area_light('BALLISTA key', (2.2, 1.6, 2.4), 900)
area_light('BALLISTA fill', (-2.4, -0.6, 1.1), 320, size=2.4, colour=(0.82, 0.88, 1.0, 1))
area_light('BALLISTA rim', (-0.9, -2.2, 1.8), 420, size=1.6, colour=(1.0, 0.94, 0.86, 1))

cam_data = bpy.data.cameras.new('BALLISTA camera')
cam = bpy.data.objects.new('BALLISTA camera', cam_data)
