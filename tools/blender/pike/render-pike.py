#!/usr/bin/env python3
"""Render hero/side/left/ads/rear proof shots of the PIKE study.

Usage:
    blender --background --factory-startup docs/design/blender/pike/pike.blend \\
        --python tools/blender/pike/render-pike.py
"""
import bpy
import sys
...
area_light('PIKE key', (2.2, 1.6, 2.4), 900)
area_light('PIKE fill', (-2.4, -0.6, 1.1), 320, size=2.4, colour=(0.82, 0.88, 1.0, 1))
area_light('PIKE rim', (-0.9, -2.2, 1.8), 420, size=1.6, colour=(1.0, 0.94, 0.86, 1))

cam_data = bpy.data.cameras.new('PIKE camera')
cam = bpy.data.objects.new('PIKE camera', cam_data)
