...
Set STUDY to 'rivet', 'kestrel', 'rivet-detail' or 'rivet-back' in the exec scope.
"""
import bpy
...
prefix='KESTREL' if study=='kestrel' else 'RIVET'
...
scene.render.filepath=str(BASE/('kestrel' if study=='kestrel' else 'rivet')/
