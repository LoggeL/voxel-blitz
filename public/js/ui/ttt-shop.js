...
const ICONS = {
  ...
  fakebody: '<circle cx="14" cy="32" r="6"/><rect x="22" y="26" width="22" height="12" rx="4"/><rect x="6" y="14" width="42" height="28" rx="6" stroke-dasharray="4 3"/>',
...
export function buildTttShop(root, purchase, close) {
  ...
  const dom = { trapSection, trapRows, root, mode: 'ttt', closeBtn, credVal, cards: {}, itemOrder: [], tttCards: cards,
    ...
    gearStatus, disguise, mark, recall, c4, fakebody, state: {} };
...
export function syncTttShop(dom, state) {
  ...
  if(owned.includes('fakebody'))info.push(ttt.fakeBodies?'Fake-Leiche: bereit':'Fake-Leiche: gelegt');
