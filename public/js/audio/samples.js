...
const sampleFileSlots = {
  ...
  'weapons.glaive.fire': `${SLOT_ROOT}/weapons/glaive/fire.ogg`,
  ...
  'human.pain.light.2': `${SLOT_ROOT}/human/pain-light-2.ogg`,
  'human.pain.light.3': `${SLOT_ROOT}/human/pain-light-3.ogg`,
  'human.pain.medium': `${SLOT_ROOT}/human/pain-medium.ogg`,
  'human.pain.medium.2': `${SLOT_ROOT}/human/pain-medium-2.ogg`,
  'human.pain.medium.3': `${SLOT_ROOT}/human/pain-medium-3.ogg`,
  'human.pain.heavy': `${SLOT_ROOT}/human/pain-heavy.ogg`,
  'human.pain.heavy.2': `${SLOT_ROOT}/human/pain-heavy-2.ogg`,
  'human.pain.heavy.3': `${SLOT_ROOT}/human/pain-heavy-3.ogg`,
...
export const BUILTIN_SAMPLE_MANIFEST = Object.freeze({
  ...
  'human.pain.medium': SAMPLE_FILE_SLOTS['human.pain.medium'],
  'human.pain.medium.2': SAMPLE_FILE_SLOTS['human.pain.medium.2'],
  'human.pain.medium.3': SAMPLE_FILE_SLOTS['human.pain.medium.3'],
  'human.pain.heavy': SAMPLE_FILE_SLOTS['human.pain.heavy'],
  'human.pain.heavy.2': SAMPLE_FILE_SLOTS['human.pain.heavy.2'],
  'human.pain.heavy.3': SAMPLE_FILE_SLOTS['human.pain.heavy.3'],
  ...
  'weapons.glaive.fire': SAMPLE_FILE_SLOTS['weapons.glaive.fire'],
