...
export const WEAPONS = {
  ...
  shotgun: {
    ...
    damage: [14.5, 5, 42], falloffStart: 4,
  ...
  minigun: {
    ...
    spreadDeg: { hip: 1.35, ads: 0.36 }, bloomDeg: 0.09, bloomMaxDeg: 2.4,
    bloomRecover: 3.4, moveSpreadDeg: 2.5,
    crouchSpreadMult: 0.68,
    recoil: {
      pitch: 0.28, pitchRamp: 0.015, maxPitchRamp: 0.22,
      yaw: 0.22,
      yawPattern: [
        -0.12, -0.28, 0.18, 0.42, 0.58, 0.30,
        -0.10, -0.55, -0.75, -0.40, 0.15, 0.45,
      ],
      jitter: 0.07, resetMs: 340, adsMult: 0.70, recovery: 0.55,
    },
    adsFov: 58, zoom: 1.2, adsTime: 0.22,
  ...
  revolver: {
    ...
    damage: [54, 28, 80], headMult: 1.9, pellets: 1,
