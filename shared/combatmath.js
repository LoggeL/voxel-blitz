...
/** Hip movement spread, ADS-reduced bloom, and hidden condition penalties. */
export function computeSpreadConeDeg(def, bloomDeg, speedXZ, adsT, panic = 0, exhaustion = 0) {
  ...
  const conditionPenalty = (panic01 * 0.85 + exhaustion01 * 1.15) * (1 - t * 0.45);
  return base + bloomDeg * (1 - t * 0.75) + conditionPenalty;
}
