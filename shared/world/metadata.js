...
export const MAP_SPAWN_ANCHORS = Object.freeze({
  ...
  killhouse: {
    // Kept off the course start pad (x 12-17, z 48-53) so a spawn never starts a timed run.
    fun: [[16, 86], [40, 86], [64, 86], [88, 86], [112, 86], [18, 76], [56, 76], [104, 76], [34, 60], [94, 60], [64, 62], [14, 60]],
    tdm: {
