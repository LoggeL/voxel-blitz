...
// Reload stills exist for the feed systems with visible mechanism work: the
// revolver's swing-out cylinder, the belt-fed LMG (cover, box, belt lead and
// charging handle) and the rocket's rear breech; 'reload-charge' is the belt
// gun's final handle rack.
const RELOAD_CAPTURE_WEAPONS = Object.freeze({ revolver: ['reload-open', 'reload-eject', 'reload-load'], lmg: ['reload-open', 'reload-eject', 'reload-load', 'reload-charge'], rocket: ['reload-open', 'reload-load'] });
