...
const RELOAD_CAPTURE_WEAPONS = Object.freeze({ revolver: ['reload-open', 'reload-eject', 'reload-load'], lmg: ['reload-open', 'reload-eject', 'reload-load', 'reload-charge'], rocket: ['reload-open', 'reload-load', 'reload-charge'] });
